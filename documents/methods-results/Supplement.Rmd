...
For ecological pressures where there are both regulation and management resilience, each is given a weight of 0.5 and where only one exists its given a weight of 1 (Table 4.9).   

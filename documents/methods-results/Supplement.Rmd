...
<span style="color: #f2cf4a; font-family: Arial, sans-serif; font-size: large;">Score = 72</span>
...
<span style="color: #f2cf4a; font-family: Arial, sans-serif; font-size: large;">Score = 95</span>
...
<span style="color: #f2cf4a; font-family: Arial, sans-serif; font-size: large;">Score = 59</span> 
...
<span style="color: #f2cf4a; font-family: Arial, sans-serif; font-size: large;">Score = 47</span> 
...
The following data layers are used to calculate the score for the Research goal:  
...
The following data layers are used to calculate the score for the Resource Access Opportunities goal:  
...
<span style="color: #f2cf4a; font-family: Arial, sans-serif; font-size: large;">Score = 97</span> 
...
<span style="color: #f2cf4a; font-family: Arial, sans-serif; font-size: large;">Score = 93</span> 
...
The following data layers are used to calculate the score for the Iconic Species sub-goal:  
...
The following data layers are used to calculate the score for the Lasting Special Places sub-goal:  
...
The following data layers are used to calculate the score for the Tourism and Recreation goal:  
...
The pressure score, p, describes the cumulative pressures acting on a goal which suppress the goal score. Pressure scores range from 0 to 1, they are calculated for each goal and include both ecological ($p_E$) and social pressures ($p_S$) (Table 4.6, Figure 4.2), such that:   
...
Fishing and pollution management layers were informed with data obtained through conversations with Alex Wegmann at The Nature Conservancy on August 25, 2020.   
